...
def get_neighbour_positions(dscrooge):
    """
    Returns the position of a cell's donald_duck as a list
    """
    donald_duck = []
    for mickey in range(0, len(dscrooge)):
        goofy = int(mickey)
        for item in range(0, mickey):
            index_cell = int(item)
            neighbour_1 = goofy - 1
            neighbour_2 = goofy + 1
            neighbour_3 = dscrooge[goofy - 1][index_cell - 1]
            neighbour_4 = dscrooge[goofy - 1][index_cell]
            neighbour_5 = dscrooge[goofy - 1][index_cell + 1]
            neighbour_6 = dscrooge[goofy + 1][index_cell - 1]
            neighbour_7 = dscrooge[goofy + 1][index_cell]
            neighbour_8 = dscrooge[goofy + 1][index_cell + 1]
