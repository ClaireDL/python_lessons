...
def get_neighbour_positions(scrooge):
    """
    ...
    for mickey in range(0, len(scrooge)):
        ...
        for item in range(0, mickey):
            ...
            neighbour_1 = goofy - 1
            neighbour_2 = goofy + 1
            neighbour_3 = scrooge[goofy - 1][index_cell - 1]
            neighbour_4 = scrooge[goofy - 1][index_cell]
            neighbour_5 = scrooge[goofy - 1][index_cell + 1]
            neighbour_6 = scrooge[goofy + 1][index_cell - 1]
            neighbour_7 = scrooge[goofy + 1][index_cell]
            neighbour_8 = scrooge[goofy + 1][index_cell + 1]
